...
const MenuAboutNews = /*@__PURE__*/ proxyCustomElement(class MenuAboutNews extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: '68c7b89c941490a9f993ff438f467b85728c2ec9', class: {
                ...
                show: !this.show,
            } }, h("div", { key: 'a283d2f9dec7a45df431e66fb78acc253809445d', class: "banner-container" }, h("ix-icon", { key: '44719bde7dd4cc7c25c5b533505015c438f59d69', color: "color-inv-contrast-text", name: 'shout', size: "32" }), h("svg", { key: '0b7609be92104e596fe316d3184f48edd4ce1759', viewBox: "0 0 48 56", xmlns: "http://www.w3.org/2000/svg" }, h("polygon", { key: 'c8bf079e3fc6c3e5ec466fdb4897629dd05aeda5', points: "0 0 48 0 48 56 24 48 0 56" }))), h("div", { key: 'f536fbadf821b348be5ba8dfea2a81aff3c35a15', class: "cui-popover-news-header" }, h("ix-typography", { key: '5dbeea3eb20c7a75b58ae63742b873d1fb0d8d4b', variant: "default-title-single" }, this.label)), h("ix-icon-button", { key: '1f1d87f8bfab4360b9038e054b5d843add2e96aa', size: "24", icon: 'close-small', ghost: true, onClick: () => {
                this.show = false;
                this.closePopover.emit();
            } }), h("div", { key: '78c8f326074a31c9e907b1ec7027145a3695a49b', class: "slot-container" }, h("slot", { key: '6064820e78272bb071f0972e9340f3a9ab7d9871' })), this.aboutItemLabel ? (h("div", { class: "cui-popover-news-footer" }, h("ix-button", { variant: "primary", onClick: (e) => {
                this.show = false;
                this.showMore.emit(e);
            } }, this.i18nShowMore))) : null, h("div", { key: 'e0f23aa73e83a1a4f7731b4dec5e738d6c1ebbf3', id: "arrow" })));
    }
    static get style() { return IxMenuAboutNewsStyle0; }
}, [1, "ix-menu-about-news", {
        "show": [1540],
        "label": [1],
...
function defineCustomElement$1() {
    ...
    const components = ["ix-menu-about-news", "ix-button", "ix-icon-button", "ix-spinner", "ix-typography"];
...
//# sourceMappingURL=ix-menu-about-news.js.map