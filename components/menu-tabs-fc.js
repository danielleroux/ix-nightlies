...
const MenuSettings = /*@__PURE__*/ proxyCustomElement(class MenuSettings extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return IxMenuSettingsStyle0; }
}, [1, "ix-menu-settings", {
...
function defineCustomElement() {
    ...
    const components = ["ix-menu-settings", "ix-icon-button", "ix-spinner", "ix-tab-item", "ix-tabs"];
    components.forEach(tagName => { switch (tagName) {
        case "ix-menu-settings":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MenuSettings);
            }
            break;
        case "ix-icon-button":
            if (!customElements.get(tagName)) {
...
const MenuTabs = ({ context }) => (h(Host, { slot: context instanceof MenuSettings ? 'ix-menu-settings' : 'ix-menu-about', class: {
        show: context.show,
    } },
    h("div", { class: context instanceof MenuSettings ? 'settings-header' : 'about-header' },
        h("h2", { class: "text-h2" }, context.label),
        h("ix-icon-button", { ghost: true, size: "24", icon: 'close', onClick: (e) => context.close.emit({
                name: context instanceof MenuSettings
                    ? 'ix-menu-settings'
                    : 'ix-menu-about',
                nativeEvent: e,
            }) })),
    h("ix-tabs", null, getTabItems(context)),
    h("slot", null)));
