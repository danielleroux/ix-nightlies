...
function defineCustomElement$1() {
    ...
    const components = ["ix-category-filter", "ix-dropdown", "ix-filter-chip", "ix-icon-button", "ix-spinner"];
...
//# sourceMappingURL=ix-category-filter.js.map