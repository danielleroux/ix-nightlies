...
export function useContextConsumer(hostElement, context, onContextReceived, subscribe) {
    let _unsubscribe;
...
export function useContextProvider(hostElement, context, contextPayload) {
