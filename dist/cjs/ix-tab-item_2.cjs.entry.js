...
const Tabs = class {
    ...
    render() {
        return (index.h(index.Host, { key: '134654adbcf4c3492c3a20162ad48c21f3ffa3dc' }, index.h("div", { key: 'eecd05941c8a8decc31f6647deb48ab2e279966b', class: "arrow", "data-arrow-left": true, onClick: () => this.move(this.scrollAmount, true) }, index.h("ix-icon", { key: '45448aa96b97f0bce6d37fec9700a2ac2fd591ad', name: 'chevron-left-small' })), index.h("div", { key: '705552c2894e0a655c27d855cb55a46e75a1fcf7', class: {
                'tab-items': true,
            ...
            } }, index.h("div", { key: '7f23535c4a4926e2162067024b0e37c13a8149f2', class: "items-content" }, index.h("slot", { key: 'e1e727370413ea4338f4eda6999eb6803228311c' }))), index.h("div", { key: '0cd120d1127015dcd779be2cee9292eef6ace6a6', class: "arrow right", "data-arrow-right": true, onClick: () => this.move(-this.scrollAmount, true) }, index.h("ix-icon", { key: '5f9c9a088f2929b64f3eca33bb5800b7a32b7397', name: 'chevron-right-small' }))));
    }
