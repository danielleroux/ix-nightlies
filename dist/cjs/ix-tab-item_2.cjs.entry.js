...
const TabItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: '62eea432a4d9c19db812f736ec3d08e03d411b48', class: this.tabItemClasses({
            ...
            } }, index.h("div", { key: '31f7dd998cfe6b2f72a57a4738d87d70b4e13383', class: {
                circle: this.rounded,
                text: !this.rounded,
                selected: this.selected,
                disabled: this.disabled,
            } }, index.h("slot", { key: '591b96b26a84f459d81d46645aa1db78748725bb' })), index.h("div", { key: '70ddcd21e4f76f4549e6c830640acdb7e33e3150', class: {
                counter: true,
                selected: this.selected,
...
const Tabs = class {
    ...
    render() {
        return (index.h(index.Host, { key: '44c009492a3faabd3dc4266f6a4070037f590caa' }, index.h("div", { key: 'c002c0b7c606bf6dd37738f2c8b233ed0556ae24', class: "arrow", "data-arrow-left": true, onClick: () => this.move(this.scrollAmount, true) }, index.h("ix-icon", { key: '30291a5baf33ad74ca4d4cdd52aa3de6fdaac6f5', name: 'chevron-left-small' })), index.h("div", { key: 'fd0842c04c463afb21e29bfb64a32189550204f0', class: {
                'tab-items': true,
            ...
            } }, index.h("div", { key: 'b62dda398149a5eef215992b4a9ce5e297fa803f', class: "items-content" }, index.h("slot", { key: '0383abae773ba6f7f5b4ebd9e76b4a20c9a18732' }))), index.h("div", { key: '7ef4269bac60f31a97ae5affa4574bbab4ba2726', class: "arrow right", "data-arrow-right": true, onClick: () => this.move(-this.scrollAmount, true) }, index.h("ix-icon", { key: '9071de44d99c4650f6ad432b40ca6592e4fa9045', name: 'chevron-right-small' }))));
    }
