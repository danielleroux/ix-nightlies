...
const Group = class {
    ...
    render() {
        return (index.h(index.Host, { key: '19b497d7ad3c1aa2d71d812dbfd1089c1b50b2e3' }, index.h("div", { key: '03e0872848ed47560ce24a00a4825f2cb68f2664', class: {
                'group-header': true,
                expand: !this.collapsed,
                selected: this.selected,
            }, tabindex: "0" }, index.h("div", { key: '41e2c2452cc5eacbfdd6618d5b8355f41cc8327f', class: "group-header-clickable", onClick: (e) => this.onHeaderClick(e) }, index.h("div", { key: '8674eb2d919f66bffff898c3a454e7ef3ef3754f', class: {
                'group-header-selection-indicator': true,
                'group-header-selection-indicator-item-selected': this.itemSelected,
            } }), index.h("div", { key: '19cac9b33c1cb86ae1c12850a812e0543ac1b0c1', class: "btn-expand-header" }, index.h("ix-icon", { key: 'eafb3888f8f934c832c2d7747eeae80646805b87', class: {
                hidden: this.slotSize === 0,
            }, name: this.collapsed ? 'chevron-right-small' : 'chevron-down-small', onClick: (e) => this.onExpandClick(e) })), index.h("div", { key: 'b319b2d6278a1d5e4954e9ffc96c67fd15b6a5f3', class: "group-header-content" }, this.header ? (index.h("div", { class: "group-header-props-container" }, index.h("div", { class: "group-header-title" }, index.h("span", { title: this.header }, this.header)), index.h("div", { class: "group-subheader", title: this.subHeader }, this.subHeader))) : null, index.h("slot", { key: 'a08d5753ca3d1a04769c79d8dfb9c40689f3f158', name: "header" }))), index.h("ix-group-context-menu", { key: '0c6452e80a02b4e1dfb1cb64195b498b399941e4' }, index.h("slot", { key: '4e83e0aec7a0a07316bce599fb67137f37227323', name: "dropdown" }))), index.h("div", { key: 'b72a5a7808c759ec319baa90e3961df273569e09', class: {
                'group-content': true,
