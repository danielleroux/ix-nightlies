...
const Select = class {
    ...
    render() {
        var _a, _b, _c;
        return (index.h(index.Host, { key: '642c38b7dad9c65ae0d4657f196a6da939975fcb' }, index.h("div", { key: '9aa58505ad684d6f69ce493ac9ad826128e4e2ab', class: {
                select: true,
            ...
            } }, index.h("div", { key: '300d5e259d4bb3c65a888e1f0842897e06f1a160', class: "input-container" }, index.h("div", { key: 'd59a18d4b7f988ce950074b0bb3127c2c285c882', class: "chips" }, this.isMultipleMode
            ...
            : '', index.h("div", { key: 'fafd86131a6ecfb882c5f93787b44c4a699c0db1', class: "trigger" }, index.h("input", { key: '1bf6fa1ee03af5ce7069f62d6529234b72d40467', autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, type: "text", class: {
            ...
            (((_c = this.selectedLabels) === null || _c === void 0 ? void 0 : _c.length) || this.inputFilterText) ? (index.h("ix-icon-button", { class: "clear", icon: 'clear', ghost: true, oval: true, size: "16", onClick: (e) => {
                ...
                if (this.editable)
                    this.dropdownWrapperRef = ref;
            } })))))), index.h("ix-dropdown", { key: 'f94abb77ed948d1e14d706a923bf5e93cb56b38b', ref: (ref) => (this.dropdownRef = ref), show: this.dropdownShow, closeBehavior: this.isMultipleMode ? 'outside' : 'both', class: {
            ...
            } }, index.h("div", { key: '4f1a7d56af3ba09f7853d0268617217dece7a244', class: {
                'select-list-header': true,
                hidden: this.hideListHeader || this.isDropdownEmpty,
            }, title: this.i18nSelectListHeader }, this.i18nSelectListHeader), index.h("slot", { key: '9bf10627950728629c29b60523c5cb86d5e0a914' }), index.h("div", { key: '528f5e388adc3c5c248e6a1d5485ae4e8ffcbfa9', ref: (ref) => (this.addItemRef = ref), class: "d-contents" }), this.isAddItemVisible() ? (index.h("ix-dropdown-item", { "data-testid": "add-item", icon: 'plus', class: {
                'add-item': true,
