...
const Select = class {
    ...
    render() {
        var _a, _b, _c;
        return (index.h(index.Host, { key: '2a59659f35973f2297d3b34cb0ae84c3e5d80c04' }, index.h("div", { key: 'cca889f2ba4c3db6e74a65fd21d9ca7428e9dc52', class: {
                select: true,
            ...
            } }, index.h("div", { key: '98ca1de8783cd95db76d969bade2aa2078c8224f', class: "input-container" }, index.h("div", { key: '4d4ac31033855345467e355f168a5ce7e47ce8c6', class: "chips" }, this.isMultipleMode
            ...
            : '', index.h("div", { key: 'd50bab808cbf2bd146c39052f7f008f94ad93f70', class: "trigger" }, index.h("input", { key: '1b91bbc00aed4ec69543d3e4c3fe1eff00c87c90', autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, type: "text", class: {
            ...
            (((_c = this.selectedLabels) === null || _c === void 0 ? void 0 : _c.length) || this.inputFilterText) ? (index.h("ix-icon-button", { class: "clear", icon: 'clear', ghost: true, oval: true, size: "16", onClick: (e) => {
                ...
                if (this.editable)
                    this.dropdownWrapperRef = ref;
            } })))))), index.h("ix-dropdown", { key: '3feb553427991c96b45b49aecce64de203846902', ref: (ref) => (this.dropdownRef = ref), show: this.dropdownShow, closeBehavior: this.isMultipleMode ? 'outside' : 'both', class: {
            ...
            } }, index.h("div", { key: '3c07355d8c3ebcc3a5f180ac8acf57297f9768ac', class: {
                'select-list-header': true,
                hidden: this.hideListHeader || this.isDropdownEmpty,
            }, title: this.i18nSelectListHeader }, this.i18nSelectListHeader), index.h("slot", { key: '2bb33255f9a58b647d0897e8ff1b38fa6aba888b' }), index.h("div", { key: '2e9bcf50f2a45e292103e4a201d421ad904becd2', ref: (ref) => (this.addItemRef = ref), class: "d-contents" }), this.isAddItemVisible() ? (index.h("ix-dropdown-item", { "data-testid": "add-item", icon: 'plus', class: {
                'add-item': true,
