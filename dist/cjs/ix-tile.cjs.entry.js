...
const Tile = class {
    ...
    render() {
        return (index.h(index.Host, { key: '587f23ee7bc91720ff10966d105782f473f00e44', class: {
                'tile-small': this.size === 'small',
                'tile-medium': this.size === 'medium',
                'tile-big': this.size === 'big',
            } }, index.h("div", { key: 'e3ae9e61a6cb4d525ecf53230537aabd64ecec3e', class: {
                'tile-header': true,
                'has-content': this.hasHeaderSlot,
            } }, index.h("slot", { key: 'd2e3c5dc465a65eb8c84f89bd7cb340d5dea3823', name: "header", onSlotchange: () => this.handleHeaderSlotChange() })), index.h("div", { key: '937ec531e8e203620c1fa8de94981bae8c4f9256', class: "tile-subheader" }, index.h("slot", { key: 'e6b7dd7fe7e4dbd68f692603a9658f86905fb70a', name: "subheader" })), index.h("div", { key: 'f745c7d22fff7f1869342cdc369328019b9320db', class: "tile-content" }, index.h("slot", { key: '198f6fa1a032a026849e1290458a5d0cb9e12de0' })), index.h("div", { key: 'add52ae52734cfb7c53709fe0bdc2aacd2432c79', class: {
                'tile-footer': true,
                'has-content': this.hasFooterSlot,
            } }, index.h("slot", { key: 'ecab235d46944a82f6c6589cb1c360be79e18fa5', name: "footer", onSlotchange: () => this.handleFooterSlotChange() }))));
    }
