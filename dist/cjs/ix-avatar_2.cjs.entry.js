...
const MenuAvatarItem = class {
    ...
    render() {
        return (index.h("ix-dropdown-item", { key: '19c0f4f0f90748af24ff82abd9a16f1e2bdcbe65', ref: this.dropdownItemRef, icon: this.icon, label: this.label, onClick: (e) => this.itemClick.emit(e) }));
    }
    get hostElement() { return index.getElement(this); }
};
