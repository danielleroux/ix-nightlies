...
const MenuAvatar = class {
    ...
    render() {
        return (index.h(index.Host, { key: '80205449f8a227f1150d29869bb751972c00e5ba', slot: "ix-menu-avatar" }, index.h("button", { key: '8c6f819b552bc4252922363b3cb5572df452d113', class: "nav-item top-item avatar no-hover", title: this.top, id: this.avatarElementId, tabIndex: 0 }, index.h("ix-avatar", { key: 'ad2c39144858f3bab508f3e669b74b6eca33a6b8', image: this.image, initials: this.initials }), index.h("div", { key: '3d460c2a1cdd5b2b1027287eaacc706ec0dbef00', class: "avatar-name" }, index.h("span", { key: '0b012eb24167bde33735ffb8c7543f1a90d51691', class: "text-default-single", title: this.top }, this.top), index.h("span", { key: 'a46ec1197af4d303f8eba3de258c9351814702dc', class: "text-default-single", title: this.bottom }, this.bottom))), index.h("ix-dropdown", { key: 'f832a8b3a424393be121cf24de5d3e56aad0c9cd', trigger: this.hostElement, placement: 'right-start', hidden: !this.showContextMenu && !this.showLogoutButton, offset: {
                mainAxis: 16,
            } }, index.h("slot", { key: 'a86dd3bf4ffc579d0a0472b00a060c3be392758b', onSlotchange: () => this.onSlotChange() }), this.showLogoutButton ? (index.h("ix-menu-avatar-item", { label: this.i18nLogout, icon: 'log-out', onClick: (e) => {
