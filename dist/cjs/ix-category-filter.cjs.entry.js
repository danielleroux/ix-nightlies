    ...
    render() {
        ...
        return (index.h(index.Host, { key: '338f4eb65b6256f5dd9d38769a5fd904e3ccdcf0' }, index.h("form", { key: 'c150680ee1a91efdffe26f99c2ba02b12876ec5b', ref: (el) => (this.formElement = el) }, index.h("div", { key: '7342837f569a500e57f106c4a2ea7b83c46f9836', "read-only": this.readonly, class: {
                ...
                'hide-placeholder': this.readonly ||
                    this.disabled ||
                    this.category !== undefined,
            }, autocomplete: "off", name: "category-filter-input", disabled: this.disabled, readonly: this.readonly, ref: (el) => (this.textInput = el), type: "text", placeholder: this.placeholder }))), this.getResetButton())), this.disabled || this.readonly ? ('') : (index.h("ix-dropdown", { show: this.showDropdown, closeBehavior: "outside", offset: { mainAxis: 2 }, anchor: this.textInput, trigger: this.hostElement, header: this.getDropdownHeader() }, this.renderDropdownContent()))));
    }
