...
const CategoryFilter = class {
    constructor(hostRef) {
        ...
        this.categoryChanged = index.createEvent(this, "categoryChanged", 7);
    ...
    toggleCategoryOperator() {
        switch (this.categoryLogicalOperator) {
            case logicalFilterOperator.LogicalFilterOperator.EQUAL:
                this.categoryLogicalOperator = logicalFilterOperator.LogicalFilterOperator.NOT_EQUAL;
                break;
            case logicalFilterOperator.LogicalFilterOperator.NOT_EQUAL:
                this.categoryLogicalOperator = logicalFilterOperator.LogicalFilterOperator.EQUAL;
                break;
        }
    }
    getFilterChipLabel(value) {
        ...
        const operatorString = value.operator === logicalFilterOperator.LogicalFilterOperator.EQUAL ? '=' : '!=';
    ...
    renderOperatorButton() {
        ...
        return (index.h(baseButton.BaseButton, Object.assign({}, params), this.categoryLogicalOperator === logicalFilterOperator.LogicalFilterOperator.NOT_EQUAL
            ? '='
            : '!='));
    }
    renderCategoryValues() {
        var _a, _b;
        return (index.h("div", { class: "dropdown-item-container" }, this.renderOperatorButton(), index.h("div", { class: "dropdown-header" }, (_a = this.categories[this.category]) === null || _a === void 0 ? void 0 : _a.label), (_b = this.categories[this.category]) === null || _b === void 0 ? void 0 :
    ...
    renderCategorySelection() {
        ...
        return (index.h("div", { class: "dropdown-item-container" }, (_a = this.getCategoryIds()) === null || _a === void 0 ? void 0 : _a.filter((id) => this.filterByInput(this.categories[id].label)).filter((id) => this.filterMultiples(id)).map((id) => {
            var _a;
            return (index.h("button", { class: "dropdown-item category-item category-item-id", "data-id": id, title: this.categories[id].label, key: id, onClick: (e) => {
                    e.preventDefault();
    ...
    getResetButton() {
        return (index.h("ix-icon-button", { onClick: (e) => this.resetFilter(e), class: {
                'reset-button': true,
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '338f4eb65b6256f5dd9d38769a5fd904e3ccdcf0' }, index.h("form", { key: 'c150680ee1a91efdffe26f99c2ba02b12876ec5b', ref: (el) => (this.formElement = el) }, index.h("div", { key: '7342837f569a500e57f106c4a2ea7b83c46f9836', "read-only": this.readonly, class: {
                'input-container': true,
                disabled: this.disabled,
                focus: this.hasFocus,
                readonly: this.readonly,
                'no-icon': this.hideIcon,
            } }, index.h("ix-icon", { key: '7ab14d3eeafec1a63e50c108796081deb7a9ea78', color: this.getIconColor(), class: { 'd-none': this.hideIcon }, name: this.icon, size: "16" }), index.h("div", { key: 'fa07482ac170fe63a01076e5fd66a5581821534d', class: "token-container" }, index.h("ul", { key: '832e0dec8c5186ab9f4a8aff9798ebbfbc5ed4a4', class: "list-unstyled" }, this.filterTokens.map((value, index$1) => (index.h("li", { key: value.toString(), class: {
            ...
            } }, (_a = this.categories[this.category]) === null || _a === void 0 ? void 0 : _a.label)), index.h("input", { key: '3fc80054d052f8c9253a60167b0cf1b1b2c8d94e', class: {
                'text-input': true,
                'hide-placeholder': this.readonly ||
                    this.disabled ||
                    this.category !== undefined,
            }, autocomplete: "off", name: "category-filter-input", disabled: this.disabled, readonly: this.readonly, ref: (el) => (this.textInput = el), type: "text", placeholder: this.placeholder }))), !this.readonly && !this.disabled && this.getResetButton())), this.disabled || this.readonly ? ('') : (index.h("ix-dropdown", { show: this.showDropdown, closeBehavior: "outside", offset: { mainAxis: 2 }, anchor: this.textInput, trigger: this.hostElement, header: this.getDropdownHeader() }, this.renderDropdownContent()))));
    }
...
exports.ix_category_filter = CategoryFilter;

//# sourceMappingURL=ix-category-filter.cjs.entry.js.map