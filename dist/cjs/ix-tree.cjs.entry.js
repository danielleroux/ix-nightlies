...
const Tree = class {
    constructor(hostRef) {
        ...
        this.nodeToggled = index.createEvent(this, "nodeToggled", 7);
        this.nodeClicked = index.createEvent(this, "nodeClicked", 7);
    ...
    render() {
        return (index.h(index.Host, { key: 'fa198f954c529db834099df3f599ecaf65223365' }, index.h("slot", { key: '54e63253af180cdd5e1c2c5048bf495475db36de' })));
    }
...
//# sourceMappingURL=ix-tree.cjs.entry.js.map