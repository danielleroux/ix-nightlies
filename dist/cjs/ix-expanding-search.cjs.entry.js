...
const ExpandingSearch = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9bd67b6447d4ab2aa3d8183b541d5118cfac926f', class: {
                expanded: this.expanded,
                'right-position': this.expanded,
                fullWidth: this.fullWidth,
            } }, index.h("ix-icon-button", { key: '53147a287683e46d23520c4a8c517ff52454cfcf', size: this.expanded ? '16' : '24', icon: this.icon, ghost: true, variant: "primary", "data-testid": "button", onClick: () => this.expandInput(), tabindex: this.expanded ? -1 : 0, color: this.hasFocus ? 'input-search-icon--color--focus' : undefined, class: {
                'btn-search': true,
                'btn-search--expanded': this.expanded,
            } }), index.h("div", { key: 'c60d58b106c39f1b3f08f340a13b64cfb7576866', class: {
                expanded: this.expanded,
                fullWidth: this.fullWidth,
                collapsed: !this.expanded,
                'disable-pointer': !this.expanded,
                'input-container': true,
            }, "data-testid": "input-wrapper" }, index.h("input", { key: 'dfb94002365e9fc5ab3e18ba4e8f30407fceade8', class: {
                'form-control': true,
                input: this.expanded,
                'disable-pointer': !this.expanded,
