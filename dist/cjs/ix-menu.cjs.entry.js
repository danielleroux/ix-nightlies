...
const Menu = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: 'dc5f861c533377667d90c4447fa69883ccd25a9c', class: {
                expanded: this.expand,
                [`breakpoint-${this.breakpoint}`]: true,
            }, slot: "menu" }, index.h("aside", { key: '3f7c3f0fdc2c34b7443270453ae02f9fc80b69d4', class: {
                menu: true,
                expanded: this.expand,
            }, onClick: () => {
                this.resetActiveTab();
            } }, index.h("div", { key: '67dae20d4923d6c3dcd55554156bce973819e0b4', class: 'menu-buttons' }, index.h("ix-burger-menu", { key: '909f53239aad6af9171204fc709806399ffb64f2', onClick: async () => this.toggleMenu(), expanded: this.expand, ixAriaLabel: this.i18nExpandSidebar, pinned: this.showPinned, class: {
                'burger-menu': true,
            } }), this.breakpoint === 'sm' &&
            this.applicationLayoutContext.appSwitchConfig && (index.h("ix-icon-button", { onClick: () => index$1.showAppSwitch(this.applicationLayoutContext.appSwitchConfig), icon: "apps", ghost: true, class: "app-switch" }))), index.h("div", { key: '2dced6457117ed28c2779da6da36b530c617d456', class: "menu-avatar" }, index.h("slot", { key: 'b980dd0ce062fad908d2abd77eac8d12dd113fe6', name: "ix-menu-avatar" })), index.h("div", { key: '5b46b35286c6d96abf3f0f0c997e7d9a9062ce09', id: "menu-tabs", style: {
                display: 'contents',
            }, onClick: (e) => this.onMenuItemsClick(e) }, index.h("div", { key: '6617a6f08eb96e86057b44f6016b4c4b5dc0d0b0', class: "tabs-top" }, index.h("slot", { key: 'fa41c0f63f37039d4f875f12379de9dd24fc7263', name: "home" })), index.h("div", { key: 'a3fdc5c413445908968fbb94cba60ab02c36635e', class: "tabs-shadow-container" }, index.h("div", { key: 'ac36763e0edf52dc07374aa5bb72e11b4f75d5cb', class: {
                'tabs--shadow': true,
                'tabs--shadow-top': true,
                'tabs--shadow--show': this.itemsScrollShadowTop,
            } }), index.h("div", { key: 'f4807e4294f0ece412ef094f7c637dfbceb6c231', class: "tabs", onScroll: () => this.handleOverflowIndicator() }, this.breakpoint !== 'sm' || !this.isHiddenFromViewport() ? (index.h("slot", null)) : null), index.h("div", { key: '1fa092109e0fced31873eca5bdf76cff0122e5ab', class: {
                'tabs--shadow': true,
                'tabs--shadow-bottom': true,
                'tabs--shadow--show': this.itemsScrollShadowBottom,
            } }))), index.h("div", { key: '7340e00be5bffcd3ea91b6cadef350bff4b2f771', class: "bottom-tab-divider" }), this.settings ? (index.h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "settings", class: {
                'internal-tab': true,
                'bottom-tab': true,
                active: this.showSettings,
            }, icon: 'cogwheel', onClick: async () => this.toggleSettings(!this.showSettings) }, this.i18nSettings)) : null, index.h("div", { key: 'f3c245f82072f5737581f59753c32d5a7486b0f2', onClick: (e) => this.onMenuItemsClick(e) }, index.h("slot", { key: '53625e79d26d534ec1cd16a51e270650ae185900', name: "bottom" })), index.h("div", { key: 'af9c50af4a7a89d877faf6acd5a97884f05a7403', id: "popover-area" }), this.about ? (index.h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "aboutAndLegal", class: {
                'internal-tab': true,
                'bottom-tab': true,
                active: this.showAbout,
            }, icon: 'info', onClick: async () => this.toggleAbout(!this.showAbout) }, this.i18nLegal)) : null, this.enableToggleTheme ? (index.h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "toggleTheme", onClick: () => themeSwitcher.themeSwitcher.toggleMode(), class: "internal-tab bottom-tab", icon: 'light-dark' }, this.i18nToggleTheme)) : null, this.enableMapExpand || ((_a = this.applicationLayoutContext) === null || _a === void 0 ? void 0 : _a.sidebar) ? (index.h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "menu-collapse", onClick: () => this.sidebarToggle(), class: "internal-tab bottom-tab", icon: `${this.getCollapseIcon()}` }, this.getCollapseText())) : null), index.h("div", { key: 'cc7443de9d327194cc7aff083033111642440efc', class: {
                'menu-overlay': true,
                ...
                this.checkTransition();
            } }, index.h("div", { key: '5a166f1447115082d0578b42768b9bf79f8df406', class: 'menu-overlay-container' }, this.showSettings ? index.h("slot", { name: "ix-menu-settings" }) : null), index.h("div", { key: '0f29a9bbb6a2acc42744818a1813329220ce5c54', class: 'menu-overlay-container' }, this.showAbout ? index.h("slot", { name: "ix-menu-about" }) : null))));
    }
