...
const Menu = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '57ed22e20f5555a24082927f659fb3350e379714', class: {
                expanded: this.expand,
                [`breakpoint-${this.breakpoint}`]: true,
            }, slot: "menu" }, index.h("aside", { key: 'd841238a2da091b1337399c6bc307a7ba14bd6c4', class: {
                menu: true,
                expanded: this.expand,
            }, onClick: () => {
                this.resetActiveTab();
            } }, index.h("div", { key: '66f09da3dc5bf343086847bcbdb43f3ad967d5f9', class: { 'menu-buttons': this.breakpoint != 'sm' } }, index.h("ix-burger-menu", { key: 'bd5312117ab2e20daf8d6ea2caa699251b607e92', onClick: async () => this.toggleMenu(), expanded: this.expand, ixAriaLabel: this.i18nExpandSidebar, pinned: this.showPinned, class: {
                'burger-menu': true,
            } }), this.breakpoint === 'sm' &&
            this.applicationLayoutContext.appSwitchConfig && (index.h("ix-icon-button", { onClick: () => index$1.showAppSwitch(this.applicationLayoutContext.appSwitchConfig), icon: "apps", ghost: true, class: "app-switch" }))), index.h("div", { key: '29ba7536d7dd3edf4c2e801290a7c60ef54c1648', id: "menu-tabs", style: {
                display: 'contents',
            }, onClick: (e) => this.onMenuItemsClick(e) }, index.h("div", { key: '450298f43c12031f665e2484f8165ba9e74b6b76', class: "tabs-shadow-container" }, index.h("div", { key: 'b312cfc3b00ce0ff1b4206be12496ab39356c759', class: {
                'tabs--shadow': true,
                'tabs--shadow-top': true,
                'tabs--shadow--show': this.itemsScrollShadowTop,
            } }), index.h("div", { key: '9ce301d9ce4555effdaab3c56c7d28e14a5c2953', class: {
                tabs: true,
                'show-scrollbar': this.expand,
            }, onScroll: () => this.handleOverflowIndicator() }, index.h("div", { key: '27ec220cb3ff2966207672ed4662c901fc9f82cb', class: "menu-avatar" }, index.h("slot", { key: '167d12d3a43c7506ffe68596992ac7fc87cc4186', name: "ix-menu-avatar" })), index.h("slot", { key: 'fe500ae0cacc669d1b3c03ef7d16defba5875e57', name: "home" }), this.breakpoint !== 'sm' || !this.isHiddenFromViewport() ? (index.h("slot", null)) : null), index.h("div", { key: 'fedcb402f5110a02abe79634824e52d1502e09fc', class: {
                'tabs--shadow': true,
                'tabs--shadow-bottom': true,
                'tabs--shadow--show': this.itemsScrollShadowBottom,
            } }))), index.h("div", { key: '57b6e359fbdc1b3d3f5d68ae6507628ae220b95f', class: "bottom-tab-divider" }), this.settings ? (index.h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "settings", class: {
                'internal-tab': true,
                'bottom-tab': true,
                active: this.showSettings,
            }, icon: 'cogwheel', onClick: async () => this.toggleSettings(!this.showSettings) }, this.i18nSettings)) : null, index.h("div", { key: '34b38c13d3964f2bed9514b09778643f05f2b2b5', onClick: (e) => this.onMenuItemsClick(e) }, index.h("slot", { key: '8455d70e542f745f251b43bcacca750ecb8870bf', name: "bottom" })), index.h("div", { key: '97714b2646dc697a2345dc2bdf6ef12f207d79ab', id: "popover-area" }), this.about ? (index.h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "aboutAndLegal", class: {
                'internal-tab': true,
                'bottom-tab': true,
                active: this.showAbout,
            }, icon: 'info', onClick: async () => this.toggleAbout(!this.showAbout) }, this.i18nLegal)) : null, this.enableToggleTheme ? (index.h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "toggleTheme", onClick: () => themeSwitcher.themeSwitcher.toggleMode(), class: "internal-tab bottom-tab", icon: 'light-dark' }, this.i18nToggleTheme)) : null, this.enableMapExpand || ((_a = this.applicationLayoutContext) === null || _a === void 0 ? void 0 : _a.sidebar) ? (index.h("ix-menu-item", { disabled: this.isHiddenFromViewport(), id: "menu-collapse", onClick: () => this.sidebarToggle(), class: "internal-tab bottom-tab", icon: `${this.getCollapseIcon()}` }, this.getCollapseText())) : null), index.h("div", { key: '7ef91f2c64302cea55ab264088f18b77a4c04965', class: {
                'menu-overlay': true,
                ...
                this.checkTransition();
            } }, index.h("div", { key: 'cb0713613fa1c00f1d86e4010f5279f168462c45', class: 'menu-overlay-container' }, this.showSettings ? index.h("slot", { name: "ix-menu-settings" }) : null), index.h("div", { key: '131513ae327f585ac96a2413494b9082fdaf112a', class: 'menu-overlay-container' }, this.showAbout ? index.h("slot", { name: "ix-menu-about" }) : null))));
    }
