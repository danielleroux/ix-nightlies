...
const MapNavigationOverlay = class {
    ...
    render() {
        var _a, _b, _c;
        return (index.h(index.Host, { key: '9a3e2f31b59a6829c87dd6422a5426c0aee2951b' }, index.h("div", { key: 'c2053424c657e0642b0e7e33bf5009b70151a2f4', class: "overlay-header" }, index.h("div", { key: 'beab8496e3e0531bf8722b4c778b6e130291a13d', class: {
                ...
                'background-color': ((_b = this.iconColor) !== null && _b !== void 0 ? _b : this.color)
                    ...
                    : '',
            } }), index.h("div", { key: '876d41acfceb40657e724482451588ccbfb06dd6', class: "overlay-header-content" }, index.h("ix-icon", { key: 'bfbdd91447f23b64f2d0a22a16b450016e9c86ce', size: "32", name: this.icon }), index.h("span", { key: '9be99e0ff37cc9023b2a66bc6be3a1af12a5a585', class: "overlay-header-title", title: this.name }, this.name)), index.h("ix-icon-button", { key: '57aed7319da3e3687ef7582849b9a35051d5e3eb', class: "overlay-close", ghost: true, icon: 'close', size: "24", onClick: () => this.closeOverlay() })), index.h("slot", { key: '8075187346f7e126505bd3defc79a6b4640da7cc' })));
    }
