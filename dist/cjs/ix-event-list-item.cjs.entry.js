...
const EventListItem = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '7ff15a330ade789ac7b480301ec299b93fb8de5e', class: {
                disabled: this.disabled,
            } }, index.h("div", { key: 'ac0e5fea94ce8e932e978be248d63588c8b96709', class: {
                'event-list-item': true,
                selected: this.selected,
                disabled: this.disabled,
            } }, index.h("div", { key: '14d0a541a98e0d2f0bb30d212c1c809c2581c4ab', class: `indicator ${!((_c = this.itemColor) !== null && _c !== void 0 ? _c : this.color) ? 'indicator-empty' : ''}`, style: {
                'background-color': ((_d = this.itemColor) !== null && _d !== void 0 ? _d : this.color) ? color : 'inherit',
                opacity: `${this.disabled ? 0.4 : 1}`,
            } }), index.h("div", { key: '282b849176585ca66412e826f111ba9bff60e48d', class: "event-list-item-container" }, index.h("div", { key: '8802f01a6419d92d39c411fb7721659e92ae59fd', class: "event-content" }, index.h("slot", { key: '64db0fea1610356e0b7ff986f3ba71f801532d55' })), this.chevron && (index.h("ix-icon", { name: 'chevron-right', size: "16", class: "chevron-icon" }))))));
    }
};
...
//# sourceMappingURL=ix-event-list-item.cjs.entry.js.map