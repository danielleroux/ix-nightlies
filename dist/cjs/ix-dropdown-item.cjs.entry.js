...
const DropdownItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd34bb3c1947e4d807fde7bc99674d1d90bffdace', class: {
                hover: this.hover,
                'icon-only': this.isIconOnly(),
                disabled: this.disabled,
                submenu: this.isSubMenu,
            }, role: "listitem" }, index.h("button", { key: 'e1d2d336b9dec9f056ad93fc62f2a9573a16aa94', type: "button", tabIndex: 0, class: {
                'dropdown-item': true,
                'no-checked-field': this.suppressChecked,
            }, onClick: () => this.emitItemClick() }, !this.suppressChecked ? (index.h("div", { class: "dropdown-item-checked" }, this.checked ? (index.h("ix-icon", { class: "checkmark", name: 'single-check', size: "16" })) : null)) : null, this.icon ? (index.h("ix-icon", { class: "dropdown-item-icon", name: this.icon })) : null, index.h("div", { key: '0544f71c5fb18304695eee5b80913866f6f59267', class: "dropdown-item-text" }, this.label, index.h("slot", { key: '01da7753d2151db1095dfcd1f9a3155611d8f2b6' })), this.isSubMenu ? (index.h("ix-icon", { name: 'chevron-right-small', class: 'submenu-icon' })) : null)));
    }
...
//# sourceMappingURL=ix-dropdown-item.cjs.entry.js.map